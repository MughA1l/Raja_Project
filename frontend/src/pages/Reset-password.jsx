            ...
            '>
                <div className='max-[470px]:w-full max-[640px]:w-8/12 sm:w-7/12 md:w-full h-full flex flex-col justify-center items-center max-sm:pt-8 p-2 pb-10'>
                    ...
                    <p className='text-[#6c6c89] max-sm:text-sm sm:text-base pt-2 font-medium text-center'>
                        Enter a new password for your account {email && <span className='font-semibold text-[#121217]'>{email}</span>}
                    </p>
                    ...
                    >
                        ...
                        <div className='flex flex-col items-start'>
                            <label htmlFor="password" className='pb-2 text-sm font-medium text-[#121217]'>New Password</label>
                            <input
                                type="password"
                                id='password'
                        ...
                        <div className='flex flex-col items-start'>
                            <label htmlFor="confirmPassword" className='pb-2 text-sm font-medium text-[#121217]'>Confirm Password</label>
                            <input
                                type="password"
                                id='confirmPassword'
