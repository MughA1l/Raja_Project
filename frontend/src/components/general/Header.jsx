...
const Header = () => {
    ...
    const getPageTitle = (pathname) => {
        ...
        if (pathname.startsWith('/Books/') && pathname.includes('/Chapters')) {
                ...
                {pageTitle.bottom ? (
                    <div>
                        ...
                        <h2 className='font-medium pt-[1px] text-xl text-dark-blue/80'>
                            {pageTitle.bottom === 'Preview' ? 'Chapter Preview' : pageTitle.bottom}
                        </h2>
                    </div>
                ) : (
            ...
            <div className='flex items-center gap-4 py-3'>
                ...
                <div className="flex items-center justify-start gap-3 w-38 cursor-pointer hover:opacity-90 duration-100">
                    ...
                    <div className='w-full'>
                        <h4 className='text-sm font-medium line-clamp-1'>Zain298_</h4>
                        <p className='text-xs line-clamp-1 break-all pt-[0.7px]'>Zain@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
